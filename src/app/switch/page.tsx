...
const options: {
  option: OptionsType;
  text: string;
  prop: (val: SwitchProps) => SwitchProps;
}[] = [
  {
    option: 'default',
    text: 'Default',
    prop: (prev) => ({ ...prev, checked: false, size: undefined }),
  },
  {
    option: 'selected',
    text: 'Selected',
...
export default function Home() {
  const [props, setProps] = useState<SwitchProps>(baseProps);
        ...
        <Switch
          onChange={() => {
            ...
            if (option) {
              ...
              setProps((prev: SwitchProps) => option?.prop(prev));
            }
          }}
          {...props}
        />
            ...
            <button
              ...
              onClick={() => {
                ...
                if (option.option === 'default') {
                  newList = selected.filter((item) => item !== 'selected' && item !== 'size-sm');
