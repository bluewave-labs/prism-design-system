...
declare function Table({ className, children, ...props }: React.ComponentProps<'table'>): react_jsx_runtime.JSX.Element;
...
declare function TableHeaderRow({ className, ...props }: React.ComponentProps<'tr'>): react_jsx_runtime.JSX.Element;
