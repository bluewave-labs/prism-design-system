...
import { P as PaginationProps } from '../pagination.d-BzBBNObS.cjs';
...
declare const Pagination: ({ currentPage, totalPages, onPageChange }: PaginationProps) => react_jsx_runtime.JSX.Element;
