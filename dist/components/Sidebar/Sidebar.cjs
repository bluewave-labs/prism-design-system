...
function Sheet(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SheetPrimitive.Root, __spreadValues({ "data-slot": "sheet" }, props));
}
function SheetPortal(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(SheetPrimitive.Portal, __spreadValues({ "data-slot": "sheet-portal" }, props));
}
...
function Tooltip(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TooltipProvider, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TooltipPrimitive.Root, __spreadValues({ "data-slot": "tooltip" }, props)) });
}
function TooltipTrigger(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TooltipPrimitive.Trigger, __spreadValues({ "data-slot": "tooltip-trigger" }, props));
}
function TooltipContent(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TooltipPrimitive.Portal, { children: /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        children,
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(TooltipPrimitive.Arrow, { className: "bg-gray-90 fill-primary z-50 size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px] dark:bg-gray-50" })
      ]
    })
  ) });
}
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
          ...
          __spreadProps(__spreadValues({
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { "data-sidebar": "sidebar", "data-slot": "sidebar-inner", className: "flex h-full w-full flex-col", children: [
              header,
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Sheet, __spreadProps(__spreadValues({ open: openMobile, onOpenChange: setOpenMobile }, props), { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
                SheetContent,
                {
                  ...
                  side,
                  children: [
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(SheetHeader, { className: "sr-only", children: [
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SheetTitle, { children: "Sidebar" }),
                      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(SheetDescription, { children: "Displays the mobile sidebar." })
                    ] }),
                    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: "flex h-full w-full flex-col menu-shadow", children })
                  ]
                }
              ) }))
            ] })
...
function SidebarTrigger(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
    ...
    __spreadProps(__spreadValues({
      ...
      children: [
        isMobile ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react2.Menu, {}) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_lucide_react2.PanelLeftIcon, {}),
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { className: "sr-only", children: "Toggle Sidebar" })
      ]
    })
  );
}
...
function SidebarMenuButton(_a) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Tooltip, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TooltipTrigger, { asChild: true, children: button }),
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(TooltipContent, __spreadValues({ side: "right", align: "center", hidden: state !== "collapsed" || isMobile }, tooltip))
  ] });
}
...
function Collapsible(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(CollapsiblePrimitive.Root, __spreadValues({ "data-slot": "collapsible" }, props));
}
...
var Content3 = ({ nav }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarContent, { children: nav == null ? void 0 : nav.map((group, index) => {
    var _a;
    return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(SidebarGroup, { children: [
      group.label && /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarGroupLabel, { className: "uppercase", children: group.label }),
      /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarGroupContent, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarMenu, { children: group.items.map(
        ({ title, url, icon, children }) => children ? /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(Collapsible, { className: "group/collapsible", children: [
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarMenuButton, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(CollapsibleTrigger2, { className: "cursor-pointer", children: [
            icon,
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: title }),
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(import_lucide_react3.ChevronDown, { className: "ml-auto transition-transform group-data-[state=open]/collapsible:rotate-180" })
          ] }) }),
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(CollapsibleContent2, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarGroupContent, { children: children.map(({ title: title2, url: url2, icon: icon2 }) => /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarMenuButton, { asChild: true, isActive: pathname === url2, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_link.default, { href: url2 != null ? url2 : "#", children: [
            icon2,
            /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: title2 })
          ] }) }) }, title2)) }) })
        ] }, title) : /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(SidebarMenuButton, { asChild: true, isActive: pathname === url, children: /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)(import_link.default, { href: url != null ? url : "#", children: [
          icon,
          /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("span", { children: title })
        ] }) }) }, title)
      ) }) })
...
var Header = ({ product = "Example" }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(SidebarHeader, { children: [
    open || isMobile && openMobile ? /* @__PURE__ */ (0, import_jsx_runtime7.jsx)("h1", { className: "flex items-center", children: product }) : null,
    !isMobile && /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(SidebarTrigger, {})
  ] });
};
...
function DropdownMenu(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(DropdownMenuPrimitive.Root, __spreadValues({ "data-slot": "dropdown-menu" }, props));
}
function DropdownMenuTrigger(_a) {
  var props = __objRest(_a, []);
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(DropdownMenuPrimitive.Trigger, __spreadValues({ "data-slot": "dropdown-menu-trigger" }, props));
}
...
var products = [
  {
    icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_lucide_react5.MonitorUp, { className: " [&>svg]:size-6" }),
    name: "UpTime",
    url: "https://uptime.uprockstaging.com",
    path: "/uptime"
  },
  {
    icon: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_lucide_react5.Globe, { className: " [&>svg]:size-6" }),
    name: "RockScapper",
...
var NavRail = ({ notifications, user, logOut }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(SidebarRail, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarHeader, { className: "p-0 w-8 h-8 md:w-10 md:h-10 justify-center", blurBg: false, children: isMobile ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarTrigger, {}) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      SidebarMenuButton,
      {
        asChild: true,
        isActive: DASHBOARD_URL.includes(url != null ? url : ""),
        className: "flex items-center justify-center h-10",
        children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_link2.default, { href: `${DASHBOARD_URL}/console`, title: "Dashboard", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_lucide_react5.Home, { className: " [&>svg]:size-6" }) })
      }
    ) }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarContent, { className: "grow", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarMenu, { className: "", children: products.map((product) => {
      var _a2;
      return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
        SidebarMenuButton,
        {
          asChild: true,
          isActive: (_a2 = product.url) == null ? void 0 : _a2.includes(url != null ? url : ""),
          className: "flex items-center justify-center h-10",
          children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_link2.default, { href: `${product.url}${product.path}`, title: product.name, children: product.icon })
        }
      ) }, product.name);
    }) }) }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarFooter, { className: "p-0 self-end", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(SidebarMenu, { className: "flex flex-col items-center justify-center gap-1", children: [
      hasNotifications ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(DropdownMenu, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DropdownMenuTrigger, { className: "flex items-center justify-center w-8 h-8 md:w-10 md:h-10", children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          "span",
          {
            className: cn(
              "relative",
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(import_lucide_react5.Bell, { className: "text-gray-10" })
          }
        ) }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          DropdownMenuContent,
          {
            ...
            children: notifications.map((notification, index) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DropdownMenuItem, { asChild: true, className: "max-w-64 flex flex-col gap-1 items-start", children: notification }, index))
          }
        )
      ] }) }) : null,
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(DropdownMenu, { children: [
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { className: "flex items-center justify-center", children: user ? /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(Avatar, { children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(AvatarFallback, { children: "JD" })
        ] }) }) }),
        /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
          DropdownMenuContent,
          {
    ...
    Sidebar,
    {
      ...
      header: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
        "div",
        {
          ...
          id: "mobile-header",
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(SidebarTrigger, {}),
            nav.some((item) => item.items.some((i) => i.url === pathname)) ? /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("h1", { className: "flex items-center", children: (_b = (_a = nav.find((item) => item.items.some((i) => i.url === pathname))) == null ? void 0 : _a.items.find((i) => i.url === pathname)) == null ? void 0 : _b.title }) : null
          ]
        }
      ),
