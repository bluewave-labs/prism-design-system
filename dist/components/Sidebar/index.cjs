      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime7.jsx)(
          ...
          __spreadProps(__spreadValues({
            ...
            children: /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)("div", { "data-sidebar": "sidebar", "data-slot": "sidebar-inner", className: "flex h-full w-full flex-col", children: [
              header,
...
var NavRail = ({ notifications, user, logOut }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(SidebarRail, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SidebarHeader, { className: "p-0 w-8 h-8 md:w-10 md:h-10 justify-center", blurBg: false, children: isMobile ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SidebarTrigger, {}) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
      SidebarMenuButton,
      {
        asChild: true,
        isActive: DASHBOARD_URL.includes(url != null ? url : ""),
        className: "flex items-center justify-center h-10",
        children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_link2.default, { href: `${DASHBOARD_URL}/console`, title: "Dashboard", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_lucide_react5.Home, { className: " [&>svg]:size-6" }) })
      }
    ) }),
    /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SidebarContent, { className: "grow", children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SidebarMenu, { className: "", children: products.map((product) => {
      var _a2;
      return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(SidebarMenuItem, { children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
        SidebarMenuButton,
        {
          asChild: true,
          isActive: (_a2 = product.url) == null ? void 0 : _a2.includes(url != null ? url : ""),
          className: "flex items-center justify-center h-10",
          children: /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(import_link2.default, { href: `${product.url}${product.path}`, title: product.name, children: product.icon })
        }
      ) }, product.name);
    }) }) }),
...
var AppSidebar = ({ product = "Example", nav, footer, notifications, logOut, user }) => {
  ...
  return !isMobile ? /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { className: "flex", suppressHydrationWarning: true, children: [
